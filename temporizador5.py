...
def voltar_para_escolha(fcr, rootcr, root):
    bvoltar = tk.Label(fcr, text="voltar", font=("Helvetica", 12, "bold"), fg="#f9e653", bg="#a2d8f1", cursor="hand2")
...
def Cronometro():
    ...
    labelcr = tk.Label(rootcr, text="Iniciar!", bg="#a2d8f1", fg="#f9e653", font="Verdana 17 bold")
    labelcr.grid(row=0, column=0, columnspan=3, pady=(50, 10), sticky='nsew')

    fcr = tk.Frame(rootcr, bg='#a2d8f1')
...
def Timer():
    ...
    labelmr = tk.Label(rootmr, text="Bem-vindo!", bg='#a2d8f1', fg="yellow", font="Verdana 17 bold")
...
def criar_janela_temporizador():
    ...
    # escrever na tela
    label = tk.Label(root, text="Faça sua escolha!", fg="#f9e653", bg="#a5d4f1", font="Helvetica 24 bold")
